...
const SUPABASE_URL = https://pducnupsopetcdtuheru.supabase.co/rest/v1/; // ระบุ URL โครงการ Supabase ของคุณ
const SUPABASE_ANON_KEY = sb_publishable_ryKUihdnOjMKRqvfzuFmjQ_zXsV-LNZ;                      // ระบุ Public Anon Key ของคุณ
