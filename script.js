...
const SUPABASE_URL = "https://your-supabase-project.supabase.co"; // ระบุ URL โครงการ Supabase ของคุณ
const SUPABASE_ANON_KEY = "your-anon-key";                      // ระบุ Public Anon Key ของคุณ
